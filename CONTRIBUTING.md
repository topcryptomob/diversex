Contributing to DiverseX
==================================

The DiverseX project operates an open contributor model where anyone is
...
The following applies to code changes to the DiverseX project, and is not to be
confused with overall DiverseX Network Protocol consensus changes.

Whether a pull request is merged into DiverseX rests with the project merge
...
Patches that change DiverseX consensus rules are considerably more involved than
...
Where a patch set proposes to change the DiverseX consensus, it must have been
...
The project leader is the release manager for each DiverseX release.
