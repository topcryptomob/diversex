...
RESOURCES += src/qt/diversex.qrc src/qt/diversex_locale.qrc

TRANSLATIONS += src/qt/locale/diversex_bg.ts \
                src/qt/locale/diversex_de.ts \
                src/qt/locale/diversex_en.ts \
                src/qt/locale/diversex_es.ts \
                src/qt/locale/diversex_fi.ts \
                src/qt/locale/diversex_fr.ts \
                src/qt/locale/diversex_it.ts \
                src/qt/locale/diversex_ja.ts \
                src/qt/locale/diversex_pl.ts \
                src/qt/locale/diversex_pt.ts \
                src/qt/locale/diversex_ru.ts \
                src/qt/locale/diversex_sk.ts \
                src/qt/locale/diversex_sv.ts \
                src/qt/locale/diversex_vi.ts \
                src/qt/locale/diversex_zh_CN.ts \
                src/qt/locale/diversex_zh_TW.ts
