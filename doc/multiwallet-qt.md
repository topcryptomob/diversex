...
In order to support loading of multiple wallets in diversex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is diversex.cpp.
...
Changes to diversex.cpp
----------------------
diversex.cpp is the entry point into diversex-qt, and as such, will require some minor modifications to provide hooks for
