...
#   c) node1 mines 32 blocks, so now node 0 has 500000DVRSX, node 1 has 4250DVRSX, node2 has none.
#   d) node0 sends 601 DVRSX to node2, in two transactions (301 DVRSX, then 300 DVRSX).
