...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DiverseX diversex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  diversex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded DiverseX transaction") + "\n" +
                               "  diversex-tx [options] -create [commands]   " + _("Create hex-encoded DiverseX transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded DiverseX transaction
