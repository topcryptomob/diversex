                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DiverseX") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DVRSX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and diversex: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DiverseX"), this);
    aboutAction->setStatusTip(tr("Show information about DiverseX"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DiverseX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DVRSX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DVRSX addresses"));
    ...
    openAction->setStatusTip(tr("Open a diversex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DiverseX help message to get a list with possible DiverseX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DiverseX client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DiverseX network", "", count));
}
...
{
    QString strTitle = tr("DiverseX"); // default title
