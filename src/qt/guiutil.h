...
/** Utility functions used by the DiverseX Qt UI.
 */
namespace GUIUtil
{
...
// Render DVRSX addresses in monospace font
...
// Parse "diversex:" URI into recipient object, return true on successful parsing
