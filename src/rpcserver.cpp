...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DiverseX server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "DiverseX server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DiverseX features */
        {"diversex", "masternode", &masternode, true, true, false},
        {"diversex", "listmasternodes", &listmasternodes, true, true, false},
        {"diversex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"diversex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"diversex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"diversex", "masternodedebug", &masternodedebug, true, true, false},
        {"diversex", "startmasternode", &startmasternode, true, true, false},
        {"diversex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"diversex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"diversex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"diversex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"diversex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"diversex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"diversex", "mnbudget", &mnbudget, true, true, false},
        {"diversex", "preparebudget", &preparebudget, true, true, false},
        {"diversex", "submitbudget", &submitbudget, true, true, false},
        {"diversex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"diversex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"diversex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"diversex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"diversex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"diversex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"diversex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"diversex", "checkbudgets", &checkbudgets, true, true, false},
        {"diversex", "mnsync", &mnsync, true, true, false},
        {"diversex", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> diversex-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:4917/\n";
}
